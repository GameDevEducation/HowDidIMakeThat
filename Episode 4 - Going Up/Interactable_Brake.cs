...
public class Interactable_Brake : MonoBehaviour, IInteractable
{
    ...
    {
        return !LinkedMotor.LimiterActive;
    }
    ...
    {
        LinkedMotor.HighlightLimiterUI();
    }

    // stop the highlight (ie. no longer interactable)
    public void StopHighlight()
    {
        LinkedMotor.UnhighlightLimiterUI();
    }
